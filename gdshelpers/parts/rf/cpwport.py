...
class CPWport(object):
    ...
    :param spacing: spacing of the port.
    :type width: float
    """
    ...
    def copy(self):
        ...
        :rtype: Port
        """
        return CPWport(self.origin, self.angle, self.width, self.spacing)
    ...
    def get_parameters(self):
        ...
        :rtype: dict
        """
        return {key: getattr(self, key) for key in ('origin', 'angle', 'width', 'spacing')}
    ...
    def set_port_properties(self, **kwargs):
        ...
        for key, value in kwargs.items():
            assert key in ('origin', 'angle', 'width', 'spacing'), '"%s" is not a valid property' % key
    ...
    def spacing(self, spacing):
        assert spacing > 0, 'Port spacing must be larger than zero'
